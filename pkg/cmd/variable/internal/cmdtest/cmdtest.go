// Package cmdtest holds shared test fixtures for variable subcommand tests.
package cmdtest
...
// Config is the shared single-host Cloud config for variable tests.
...
// NoPipelineFake wraps backend.Client without implementing backend.PipelineClient.

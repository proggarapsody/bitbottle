...
| [`pick-mode.sh`](../../../auto-iter/scripts/pick-mode.sh) | ✅ | (none — reads `cycles.jsonl` + `docs/backlog/BACKLOG.md`) | `{"cycle":N,"mode":"iteration\|architecture\|brainstorm\|stop","open_scopes":N,"consecutive_empty_brainstorms":N,"reason":"..."}`. Honors the documented algorithm: cycle%5 → architecture, empty backlog + 3 trailing empty brainstorms → stop. |
| [`pick-scope.sh`](../../../auto-iter/scripts/pick-scope.sh) | ✅ | (none — reads `docs/backlog/BACKLOG.md`) | `{"slug":"...","scope_name":"...","summary":"...","backend":"Cloud\|Server\|Both","tier":"1\|2\|3\|DX","has_scope_details":bool,"details_anchor":"#..."\|null}`. Halts `backlog_empty` if no 🔲 rows. |

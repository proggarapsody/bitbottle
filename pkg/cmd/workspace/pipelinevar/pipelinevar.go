// Package pipelinevar implements the `bitbottle workspace pipeline-variable`
// command group. These are workspace-scoped pipeline variables on Bitbucket
// Cloud, distinct from repo-level and deployment-level variables.
package pipelinevar
...
// back to the pinned repo's namespace. An error is returned when neither is
// available.

...
func projectFields(f *factory.Factory, cfg format.OutputConfig) *format.Printer[backend.Project] {
	p := format.New[backend.Project](f.IOStreams.Out, f.IOStreams.IsStdoutTTY(), cfg)

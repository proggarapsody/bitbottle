...
func TestDefaultReviewerRemove_CallsBackend(t *testing.T) {
	t.Parallel()
	...
	cmd := pr.NewCmdPRDefaultReviewerRemove(f)
...
func TestDefaultReviewerRemove_UnsupportedBackend(t *testing.T) {
	t.Parallel()

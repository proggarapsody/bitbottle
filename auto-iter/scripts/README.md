...
**Canonical interface catalog**: [`../scripts.md`](../scripts.md). That's where every script's input contract, JSON output shape, and replacement target lives. This README is just an entry point — don't duplicate the catalog here.
...
1. Read [`../scripts.md`](../scripts.md) → Planned table — pick a row or add one.

...
func TestAllFeatureSpecs_Coverage(t *testing.T) {
	t.Parallel()
	// All 79 expected names must be present in AllFeatureSpecs.
	expected := []string{
		...
		"PRCommentStateSetter", "PRFileClient", "PRMergePreviewClient", "PRParticipantClient", "PRParticipantUpdater", "PRReopener",
		...
		"PipelineOIDCClient",
		"PipelineScheduleClient", "PipelineSSHKeyPairClient", "PipelineTestReportClient", "PipelineTriggerClient",
		"RefComparer",
		...
		"WorkspacePermsClient", "WorkspacePipelineVariableClient", "WorkspaceProjectDefaultReviewerClient", "WorkspaceProjectPermsClient", "WorkspaceSearcher", "WorkspaceVariableClient", "WorkspaceWebhookClient",
	}
